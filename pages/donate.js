    ...
    <Layout>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col mt-8">
          ...
          <Image
            className="mx-auto md:mx-0 my-4 rounded-md"
            src="/BTC.png"
            alt="BTC QRcode"
            width="240"
            height="240"
          ...
          <div className="flex gap-2 mx-auto md:mx-0 max-w-[240px]">
            <p className="mt-2 bg-gray-600 px-1 py-1 rounded-md overflow-hidden">{btcWalletAddress}</p>
            <button className="mt-2 bg-gray-600 px-1 py-1 rounded-md w-8 max-w-[240px]" onClick={handleCopyBtcAddress}>
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex gap-2 mx-auto md:mx-0 max-w-[240px]">
            <p className="mt-2 bg-gray-600 px-1 py-1 rounded-md overflow-hidden">{ltcWalletAddress}</p>
            <button className="mt-2 bg-gray-600 px-1 py-1 rounded-md w-8 max-w-[240px]" onClick={handleCopyLtcAddress}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 006.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0015 2.25h-1.5a2.251 2.251 0 00-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 00-9-9z" />
              </svg>
            </button>
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex gap-2 mx-auto md:mx-0 max-w-[240px]">
            <p className="mt-2 bg-gray-600 px-1 py-1 rounded-md overflow-hidden">{ethWalletAddress}</p>
            <button className="mt-2 bg-gray-600 px-1 py-1 rounded-md w-8 max-w-[240px]" onClick={handleCopyEthAddress}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 006.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0015 2.25h-1.5a2.251 2.251 0 00-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 00-9-9z" />
              </svg>
            </button>
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex gap-2 mx-auto md:mx-0 max-w-[240px]">
            <p className="mt-2 bg-gray-600 px-1 py-1 rounded-md overflow-hidden">{dogeWalletAddress}</p>
            <button className="mt-2 bg-gray-600 px-1 py-1 rounded-md w-8 max-w-[240px]" onClick={handleCopyDogeAddress}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 006.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0015 2.25h-1.5a2.251 2.251 0 00-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 00-9-9z" />
              </svg>
            </button>
      ...
      <div className="flex flex-col mt-4">
        ...
        <Link
          className="flex gap-2 items-center px-3 py-1 mx-auto rounded-md bg-gray-700"
