    ...
    return (
        <Layout>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-3xl text-center md:text-left font-bold text-aulaBlack">
                    About
                </h1>
                ...
                <h2 className="text-xl text-center md:text-left font-bold text-aulaBlack">
                    My Story
                </h2>
                <p className="mt-4 text-gray-700">
                ...
                <p className="mt-8 text-gray-700">With respect,</p>
                <p className="font-bold text-aulaGray">Ladislav Bagari</p>
            </div>
            {/* </Card> */}
        </Layout>
    );
