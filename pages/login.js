      ...
      <div className="h-screen flex items-center">
        <div className="max-w-xs mx-auto grow -mt-36">
          ...
          <button
            ...
            className="flex w-full gap-4 my-2 py-4 px-8 rounded-md items-center border-2 bg-white dark:bg-gray-800 shadow-xl shadow-gray-200 dark:shadow-none border-gray-100 dark:border-gray-900 hover:bg-aulaBlack hover:text-white stroke-aulaGray dark:stroke-gray-50 hover:stroke-white  transition-all hover:scale-110"
          >
          ...
          {showOverlay && (
            <div className="p-4 bg-white dark:bg-gray-800 rounded-md shadow-xl shadow-gray-200 dark:shadow-none border border-1 border-gray-100 dark:border-gray-900">
              <label className="block text-center mb-4">Your email:</label>
              <input className="w-full rounded-lg px-4 py-2 bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-50 border-2 border-gray-300 dark:border-gray-600 focus:outline-none focus:border-indigo-500"
                type="text"
                value={loginEmail}
                onChange={(e) => setLoginEmail(e.target.value)} />
              <button
                onClick={signInWithMagicLink}
                className="flex mx-auto gap-4 mt-4 py-2 px-3 rounded-lg items-center justify-center text-white bg-aulaBlack transition-all hover:scale-110"
          ...
          {!showOverlay && (
            <button
              ...
              className="flex w-full gap-4 my-2 py-4 px-8 rounded-md items-center border-2 bg-white dark:bg-gray-800 shadow-xl shadow-gray-200 dark:shadow-none border-gray-100 dark:border-gray-900 hover:bg-aulaBlack hover:text-white fill-aulaGray dark:fill-gray-50 hover:fill-white transition-all hover:scale-110"
            >
          ...
          <p className="mt-4 text-sm text-center">By registering or signing in, you accept our <Link className="text-aulaBlack" href="/privacy-policy">GDPR (for EU) and Privacy Policy.</Link></p>
        </div>
      </div>
    </Layout>
  );
