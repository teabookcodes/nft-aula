...
export default function Footer() {
    ...
    return(
        <div className="block text-center md:flex mt-8 md:mt-12 -mb-8 md:mb-4 -mx-4 md:mx-0 py-4 px-4 md:px-0 items-center justify-between bg-aulaGray md:bg-transparent">
           <div>
