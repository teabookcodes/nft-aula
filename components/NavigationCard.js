...
export default function NavigationCard() {
  ...
  const activeElementClasses =
    "text-sm md:text-md flex items-center md:gap-3 py-3 my-1 md:-mx-1 md:px-5 bg-aulaBlack text-white px-4 rounded-full shadow-md shadow-gray-300";
  const nonActiveElementClasses =
    "text-sm md:text-md flex items-center md:gap-3 py-2 my-2 hover:bg-aulaBlack hover:bg-opacity-10 px-4 rounded-full transition-all hover:scale-110 hover:shadow-md shadow-gray-300";
  ...
  return (
    <Card noPadding={true}>
      <div className="px-4 py-2 flex gap-4 justify-between md:block rounded-md shadow-md shadow-gray-500 md:shadow-none">
        ...
        <div className="hidden md:block">
          ...
          <Link
            href="/"
            className={
              pathname === "/categories/collectibles"
                ? activeElementClasses
                : nonActiveElementClasses
            }
          >
